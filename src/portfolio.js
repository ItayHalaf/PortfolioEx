...
import FullSizeElementComponent from "./full-size-element-component";
    ...
    switch (this.state.contentToShow) {
      ...
      case ContentTypes.EditItem:
        ...
        case ContentTypes.FullSizeItem:
          const itemToExpand = this.state.items.filter(item => item.id === this.state.activeId.toString())[0];
          contentToShow = <FullSizeElementComponent onClick={this.changeToProptflio} {...itemToExpand}/>;
          break;
